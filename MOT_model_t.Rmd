...
te2<- t_data %>% 
  mutate(fit_list = apply(t_data,1,fit_submodel2,meth="hamming"),
         score = sapply(fit_list,getscore)) 
...
te2<- t_data %>% 
  mutate(fit_list = apply(t_data,1,fit_submodel2,meth="lcs"),
         score = sapply(fit_list,getscore)) 
...
te2<- t_data %>% 
  mutate(fit_list = apply(t_data,1,fit_submodel2,meth="qgram"),
         score = sapply(fit_list,getscore)) 
...
te2<- t_data %>% 
  mutate(fit_list = apply(t_data,1,fit_submodel2,meth="cosine"),
         score = sapply(fit_list,getscore)) 
...
te2<- t_data %>% 
  mutate(fit_list = apply(t_data,1,fit_submodel2,meth="jaccard"),
         score = sapply(fit_list,getscore)) 
...
te2<- t_data %>% 
  mutate(fit_list = apply(t_data,1,fit_submodel2,meth="jw"),
         score = sapply(fit_list,getscore)) 
...
```{R}
te2<- t_data %>% 
  mutate(fit_list = apply(t_data,1,fit_submodel2,meth="soundex"),
         score = sapply(fit_list,getscore)) 
...
```{R}
te3<- t_data %>% 
  mutate(fit_list = apply(t_data,1,fit_submodel2,meth="osa"),
         score = sapply(fit_list,getscore)) 
